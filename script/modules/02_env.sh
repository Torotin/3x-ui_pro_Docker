...
ensure_env_defaults() {
	...
	export ADMIN_ROUTING_MODE ENABLE_AMNEZIAWG STRICT_DNS_CHECK STRICT_ACME_CHECK
	export AMNEZIAWG_IMAGE AMNEZIAWG_INTERFACE AMNEZIAWG_LISTEN_PORT AMNEZIAWG_INTERNAL_PORT
	export AMNEZIAWG_SERVER_ADDRESS AMNEZIAWG_CLIENT_IPV4_PREFIX AMNEZIAWG_CLIENT_COUNT
	export AMNEZIAWG_CLIENT_DNS AMNEZIAWG_ENDPOINT_HOST AMNEZIAWG_MTU AMNEZIAWG_NAT_BACKEND
	export AMNEZIAWG_IPV6_ENABLE
	export AMNEZIAWG_JC AMNEZIAWG_JMIN AMNEZIAWG_JMAX AMNEZIAWG_S1 AMNEZIAWG_S2
	export AMNEZIAWG_H1 AMNEZIAWG_H2 AMNEZIAWG_H3 AMNEZIAWG_H4
