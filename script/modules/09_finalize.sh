...
install_prepare_summary_env() {
	...
	SUMMARY_AMNEZIAWG_ENABLED=${ENABLE_AMNEZIAWG:-false}
	SUMMARY_AMNEZIAWG_CLIENT_CONFIG="$INSTALL_ROOT/amneziawg/clients/client1.conf"
	...
	export SUMMARY_AMNEZIAWG_ENABLED SUMMARY_AMNEZIAWG_CLIENT_CONFIG
