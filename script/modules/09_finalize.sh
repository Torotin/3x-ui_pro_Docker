...
install_prepare_summary_env() {
	...
	SUMMARY_PORT_LOCAL_TELEMT_PROXY=${PORT_LOCAL_TELEMT_PROXY:-9443}
	SUMMARY_PORT_LOCAL_TELEMT_API=${PORT_LOCAL_TELEMT_API:-9091}
	SUMMARY_PORT_LOCAL_TELEMT_PANEL=${PORT_LOCAL_TELEMT_PANEL:-8080}
	...
	SUMMARY_URL_TELEMT_PANEL=$(install_summary_url "${URI_TELEMT_PANEL:-}")
	...
	export SUMMARY_PORT_LOCAL_XHTTP SUMMARY_PORT_LOCAL_VISION SUMMARY_PORT_LOCAL_TELEMT_PROXY
	export SUMMARY_PORT_LOCAL_TELEMT_API SUMMARY_PORT_LOCAL_TELEMT_PANEL SUMMARY_PORT_LOCAL_DOZZLE SUMMARY_PORT_LOCAL_CADDYWEB
	...
	export SUMMARY_URL_DOZZLE SUMMARY_URL_TRAEFIK SUMMARY_URL_TELEMT_PANEL
}
